...
Nos permiten bifurcar el flujo de nuestro código y en función de una condición
podemos elegir un camino de código u otro.
...
switch(_var_a_comparar_){
    ...
    ...
    default: {
        /* CODIGO A EJECUTAR SI _var_a_comparar_ no es igual a ninguno de los 
        valores del case */
    }
}
